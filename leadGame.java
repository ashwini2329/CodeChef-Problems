...
public class leadGame {
	public static void main(String[] args) {
		...
		for(int i=0; i<rounds; i++) {
		    ...
		    comScore1+=player1Score;
		    comScore2+=player2Score;
		    
		    if(comScore1 > comScore2) {
		        int lead1 = comScore1 - comScore2;
		        if(lead1 > player1MaxLead) {
		            player1MaxLead = lead1;
		        }
		    } if(comScore2 > comScore1) {
		        int lead2 = comScore2 - comScore1;
		        if(lead2 > player2MaxLead) {
		            player2MaxLead = lead2;
		        }
		    }
		}
